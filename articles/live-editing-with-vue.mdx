...
For an example integration, check out our [Sendit Nuxt template](/community/themes/sendit/).
If you have any issues, please [contact support](/contact/), or [raise an issue on the GitHub repository](https://github.com/CloudCannon/visual-editor-connector/issues).
