...
In the previous section of this guide, we created our [CloudCannon configuration file](/documentation/articles/setting-global-configuration), `cloudcannon.config.yml`. The sidebar prompt to create the configuration file has disappeared.
...
As you can see, we have enabled many of the common functions your team would expect in a content editor. But that’s not all! Check out our documentation for many more ways to [configure the WYSIWYG toolbar](/documentation/articles/defining-editable-regions-in-your-html/#options).
...
We covered inputs in the previous section of our guide, and you can always check out our documentation for [customizing your inputs](/documentation/articles/how-to-choose-what-input-is-used-in-the-data-editor) to see more options.
...
Data files are automatically available to update in the [Data Editor](/documentation/articles/introducing-the-data-editor). The same [inputs configuration](/documentation/articles/how-to-choose-what-input-is-used-in-the-data-editor) you used for the front matter will also work on data files.
