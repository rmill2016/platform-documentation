...
<comp.CommonContent data={{ _file: "/usr/local/__site/src/_common_content/starter-guides/starter-guide-step-5.mdx" }}>
  <comp.SlotContent name="SSG_Visual_Previews_Paragraph">
    ...
    The [Vue Connector](/documentation/articles/live-editing-with-vue) is our open-source tool which listens for live editing events in the Visual Editor. CloudCannon will re-render your page as changes occur, generating a preview of your page as you edit.
    ...
    * Components will need to use the Vue `onMounted` and `onBeforeUnmount` hooks.
    ...
    For an example integration, check out our [Sendit Nuxt template](/community/themes/sendit), or [reach out to our support team](/documentation/support).
  </comp.SlotContent>
</comp.CommonContent>