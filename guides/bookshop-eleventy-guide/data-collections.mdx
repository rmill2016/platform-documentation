...
One thing to note is that Bookshop is tied to [CloudCannon's collection model](/documentation/articles/defining-your-collections/), not Eleventy's.
...
which means it does need to be defined using [data_config in your CloudCannon configuration file](/documentation/articles/defining-your-data/).
