...
Before we start, this guide assumes you already have a SvelteKit site uploaded to a Git repository. Although you can [upload files directly](/documentation/articles/create-a-site-with-direct-upload) from your hard drive, we highly recommend using a Git repository.

Don’t have a SvelteKit site yet? No worries! You can create one with our [Jamstack tutorials for your favorite SSGs](/tutorials).
