...
Input configuration is passed directly to CloudCannon; see the [CloudCannon Inputs Documentation](/documentation/articles/how-to-choose-what-input-is-used-in-the-data-editor/) to read more.