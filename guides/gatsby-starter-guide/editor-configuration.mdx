...
<comp.CommonContent data={{ _file: "/usr/local/__site/src/_common_content/starter-guides/starter-guide-step-5.mdx" }}>
  <comp.SlotContent name="SSG_Visual_Previews_Paragraph">
    ...
    For more react connector options, read our <a target="_blank" rel="noopener noreferrer" href="https://github.com/CloudCannon/react-connector">GitHub React Connector guide</a>, or [reach out to our support team](/documentation/support).
  </comp.SlotContent>
</comp.CommonContent>